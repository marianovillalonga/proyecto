  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	<input type="text" name="" id="default_module" class="form-control input-sm">
      </div>
...
<div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Actualizar Roles</h4>
      </div>
      <div class="modal-body">
        	...
        	<label>Default Module</label>
        	<input type="text" name="" id="default_moduleu" class="form-control input-sm">
      </div>
      <div class="modal-footer">
    ...
    $(document).ready(function(){
        $('#guardarnuevo').click(function(){
          ...
          default_module=$('#default_module').val();
            agregardatos(nombre,default_module);
        });
